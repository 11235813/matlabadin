...
raw.HammerofWrath= ((4890+5405)./2 + 0.15.*player.hsp + 0.15.*player.ap).*mdf.spdmg.*target.resrdx; %4386+4847 base @ 80
...
raw.Exorcism=       ((2212+2471)./2 + 0.15.*max([player.hsp;player.ap])) ...   %1985+2215 base @ 80
...
%Holy Wrath
raw.HolyWrath=      (3251./exec.npccount+0.3.*player.hsp).*mdf.spdmg.*target.resrdx;  %2800 base @ 80
