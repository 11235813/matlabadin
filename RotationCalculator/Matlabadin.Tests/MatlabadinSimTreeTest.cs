...
namespace Matlabadin.Tests
{
    ...
    public class MatlabadinSimTreeTest : MatlabadinTest
    {
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("HotR"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 1, 0, 0, 0.75, 0.75);
            MatlabadinSimTree<BitVectorState> mst = new MatlabadinSimTree<BitVectorState>(gp, gp);
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("SotR>CS"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 1, 0, 0, 0, 0);
            MatlabadinSimTree<BitVectorState> mst = new MatlabadinSimTree<BitVectorState>(gp, gp);
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("CS"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 1, 0, 0, 0.75, 0.75);
            MatlabadinSimTree<BitVectorState> mst = new MatlabadinSimTree<BitVectorState>(gp, gp);
            for (int i = 0; i < 8; i++)
            {
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("^WB>^SS>AW5>SotR5>CS>J>AS>Cons"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0, 0.95, 0.95);
            MatlabadinSimTree<BitVectorState> mst = new MatlabadinSimTree<BitVectorState>(gp, gp);
