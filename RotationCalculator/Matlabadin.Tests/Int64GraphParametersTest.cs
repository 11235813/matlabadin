...
namespace Matlabadin.Tests
{
    ...
    public class Int64GraphParametersTest : MatlabadinTest
    {
        ...
        {
            Int64GraphParameters target = new Int64GraphParameters(R, PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0, 0, 0);
        ...
        {
            Int64GraphParameters target = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("Cons"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0, 0, 0);
        ...
        public void UnusedAbilitiesShouldHaveZeroBitSize()
        {
            ...
            Int64GraphParameters target = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("CS>J"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0, 0, 0);
            ...
            target = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("HotR"), PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0, 0, 0);
            Assert.AreNotEqual(0, target.AbilityCooldownBits[(int)Ability.CS]);
        }
        [Test]
