function [ damage_timeline ] = generate_random_damage_alt_timeline( fight_length,damage_mean,damage_var,swing_timer )
...
damage_timeline=zeros(fight_length,1);
    ...
    for i=1:num_swings
        ...
        if rand>avoidance
            ...
            base_damage=damage_mean*(1+2*damage_var*(rand()-0.5));
