...
idb.iid(63531).str=341;
idb.iid(63531).sta=512;
idb.iid(63531).mast=168;
idb.iid(63531).parry=168;
...
idb.iid(67138).name='Cataclysm World Drop Epic STR DPS Neck';
...
idb.iid(65379).name='Sky Strider Greaves';
...
idb.iid(55060).str=341;
idb.iid(55060).sta=512;
idb.iid(55060).crit=228;
idb.iid(55060).mast=228;
...
idb.iid(67238).hit=92;
idb.iid(67238).mast=112;
...
idb.iid(55061).str=253;
idb.iid(55061).sta=380;
idb.iid(55061).hit=169;
idb.iid(55061).haste=169;
...
idb.iid(67141).name='Cataclysm World Drop Epic Plate DPS Legs';
idb.iid(67141).ilvl=359;
idb.iid(67141).str=301;
idb.iid(67141).sta=512;
idb.iid(67141).hit=188;
idb.iid(67141).haste=228;
...
idb.iid(67139).name='Cataclysm World Drop Epic Strength DPS Ring';
