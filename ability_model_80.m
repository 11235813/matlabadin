...
raw.HammerNova=   ((523+783)./2).*mdf.spdmg.*mdf.Crus.*mdf.t10x2.*mdf.glyphHotR; %523+783 base @ 80
...
%Avenger's Shield
raw.AvengersShield= ((2512+3070)./2+0.42.*player.ap+0.22.*player.hsp).*mdf.spdmg.*mdf.glyphAS; %2512+3070 base @ 80
...
%Hammer of Wrath
raw.HammerofWrath=  ((1124+1242)./2 + 0.15.*player.hsp + 0.15.*player.ap).*mdf.spdmg; %1124+1242 base @ 80
...
%Holy Wrath
raw.HolyWrath=      (2153+0.3.*player.hsp).*mdf.spdmg;  %2153 base @ 80
