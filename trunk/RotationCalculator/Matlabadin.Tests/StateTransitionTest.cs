...
namespace Matlabadin.Tests
{
    ...
    public class StateTransitionTest : MatlabadinTest
    {
        ...
        {
            var gp = new Int64GraphParameters(new RotationPriorityQueue<BitVectorState>("J"), PaladinSpec.Prot, PaladinTalents.None, PaladinGlyphs.None, 3, 0, 1, 1);
            var sm = gp;
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(R, PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0.8, 1);
        ...
        {
            Int64GraphParameters gp = new Int64GraphParameters(R, PaladinSpec.Prot, PaladinTalents.All, PaladinGlyphs.None, 3, 0, 0.8, 0);
        ...
        public void CalculateTransition_ShouldConcatentateSingleTransitionStates()
        {
            ...
            var gp = new Int64GraphParameters(r, PaladinSpec.Prot, PaladinTalents.None, PaladinGlyphs.None, 3, 0, 0.9, 0.9);
